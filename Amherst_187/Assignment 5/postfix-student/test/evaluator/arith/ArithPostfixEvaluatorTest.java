...
public class ArithPostfixEvaluatorTest {
	...
	@Test (timeout = 5000)
	public void testEvaluateMultipleOperations() throws Exception {
		Integer result = evaluator.evaluate("4 5 7 2 + - *");
		assertEquals(new Integer(-16), result);
		
		result = evaluator.evaluate("2 200 100 10 5 / - + * !");
		assertEquals(new Integer(-596), result);
	}
