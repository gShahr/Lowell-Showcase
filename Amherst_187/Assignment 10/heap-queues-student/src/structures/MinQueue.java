...
public class MinQueue<V> implements PriorityQueue<Integer, V> {
	...
	/** used this as a way to return a new instance of the objected each time a new value was added
	public MinQueue(StudentArrayHeap<Integer, V> other) {
		heap = other;
	} */
	...
	public PriorityQueue<Integer, V> enqueue(Integer priority, V value) {
		...
		heap.add(priority, value); // add to heap
		/* PriorityQueue<Integer, V> queue = new MinQueue(heap);  //create new object to account for added element
		return queue; */
		return this; // return an instance of the object 
	}
